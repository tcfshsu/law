...
static void
wasm_invoke_iliii (void *target_func, MonoInterpMethodArguments *margs)
{
	typedef int (*T)(int64_t arg_0, int arg_1, int arg_2, int arg_3);
	T func = (T)target_func;
	int res = func (mono_wasm_interp_method_args_get_larg (margs, 0), mono_wasm_interp_method_args_get_iarg (margs, 2), mono_wasm_interp_method_args_get_iarg (margs, 3), mono_wasm_interp_method_args_get_iarg (margs, 4));
	void *retval = mono_wasm_interp_method_args_get_retval (margs);
	*(int*)retval = res;
}
...
static unsigned int interp_to_native_signatures_count = 58;
